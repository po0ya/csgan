...
class FMnist(Dataset):
    ...
    Attributes:
        ...
        split_data: A dictionary of 
            {
                'train': Images of np.ndarray, Int array of labels, and int array of ids.
                'val': Images of np.ndarray, Int array of labels, and int array of ids.
                'test': Images of np.ndarray, Int array of labels, and int array of ids.
            }
    """
    ...
    def load(self, split='train', lazy=False):
